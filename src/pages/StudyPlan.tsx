...
const StudyPlan: React.FC = () => {
  ...
  const todaysLessons = [
    ...
    },
    {
      ...
      duration: "20 min",
      completed: true,
      onClick: () => navigate("/grammar/lessons/1"),
    },
    {
    ...
    <PageLayout pageData={pageData}>
        ...
        <div className="flex justify-between">
          {weeklyOverview.map((day, index) => (
            <div key={index} className="text-center">
              <div
                className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-sm font-bold mb-1 ${
                  day.completed
      ...
      <SectionGrid title="Your Progress" className="mb-8">
        <ProgressCard
          ...
          color="green"
        />
        <ProgressCard title="Grammar" current={45} total={100} color="blue" />
        <ProgressCard
