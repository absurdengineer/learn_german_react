...
// Define a simpler structure for a grammar mistake
...
// Define the session result structure for grammar
...
const GrammarSessionResults: React.FC<GrammarSessionResultsProps> = ({
  results,
  sessionType,
  onRestart,
  onReviewMistakes,
                ...
                <ul className="space-y-4">
                  {mistakes.map((mistake, index) => (
                    <li key={index} className="p-4 bg-white rounded-lg shadow-md">
                      <p className="font-semibold text-lg text-gray-800">{mistake.question}</p>
...
export default GrammarSessionResults;
