      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        <div className="p-4 sm:p-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 pr-4">
                {word.german}
              </h2>
              {word.pronunciation && (
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              <span
                className={`px-3 sm:px-4 py-2 text-sm rounded-xl font-medium ${getWordTypeColor(
                  word.type
                )}`}
              >
                {word.type}
              ...
              {word.gender && (
                <span
                  className={`px-3 sm:px-4 py-2 text-sm rounded-xl font-medium ${getGenderColor(
                    word.gender
                  )}`}
                >
                  {word.gender}
