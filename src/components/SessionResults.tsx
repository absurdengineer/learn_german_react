...
const SessionResults: React.FC<SessionResultsProps> = ({
  ...
  const { totalQuestions, correctAnswers, wrongAnswers, timeSpent, mistakes } =
    results;
  ...
  // Don't show accuracy for vocabulary practice sessions
  const isVocabularyPractice =
    sessionType.toLowerCase().includes("vocabulary") ||
    sessionType.toLowerCase().includes("flashcards") ||
    sessionType.toLowerCase().includes("translation") ||
    sessionType.toLowerCase().includes("multiple choice");
